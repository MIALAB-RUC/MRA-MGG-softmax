...
sigma=4.9;
tic_original_em = tic();
x_original_em = MRA_EM(X_data, sigma);
...
% %% 
% relerr_proposed( relerr_proposed<0.01)=0;
% relerr_em(relerr_em<0.01)=0;
% relerr_invfeatmra_1(relerr_invfeatmra_1<0.01)=0;
% relerr_invfeatmra_2(relerr_invfeatmra_2<0.01)=0;
% relerr_invfeatmra_3(relerr_invfeatmra_3<0.01)=0;
% relerr_invfeatmra_4(relerr_invfeatmra_4<0.01)=0;
